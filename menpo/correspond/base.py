...
from .flatinterp import TriMeshCorresponder
...
class TriMeshMapSampler(object):
    r"""
    ...
    def __init__(self, target, interpolator=ThinPlateSplines,
        ...
        self.f_interp = FlattenInterp(target, interp=interpolator,
        ...
        r_h, r_w = self.f_interp.f_tgt_2d.range()
        ...
        cs_transform = model_to_clip_transform(self.f_interp.f_tgt_3d,
